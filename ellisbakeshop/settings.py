"""
Django settings for ellisbakeshop project.
...
USER_FOLDER_NAME = 'ellisbakeshop'
home = Path.home()
...
ALLOWED_HOSTS = ['localhost', 'ellisbakeshop.com', 'www.ellisbakeshop.com']

CSRF_TRUSTED_ORIGINS = ['https://*.ellisbakeshop.com']
...
ROOT_URLCONF = 'ellisbakeshop.urls'
